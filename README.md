...
When you create a scene, *ScrollXP* will generate a [TimelineMax](https://greensock.com/timelinemax/).
...
When you set an attribute of `data-animate-from-*` or `data-animate-to-*`, the *tween* uses:
...
When you add a `data-animate-stagger` attribute to your element, the *tween* uses:
